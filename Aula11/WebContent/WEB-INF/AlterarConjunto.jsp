                    ...
                    <form action="controller.do" method="post">
                        ...
                        <div class="row">
                            <div class="form-group col-md-12">
                                ...
                                <input type="text" class="form-control" name="nome" id="nome" required maxlength="100" placeholder="nome completo" value="${conjunto.nome }">
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group col-md-6">
                                <label for="fone">Andar</label>
                                <input type="tel" class="form-control" name="fone" id="andar" maxlength="15" pattern="(?:\(\d{2}\)|\d{2})[- ]?\d{5}[- ]?\d{4}"  value="${conjunto.andar}">
                            </div>
